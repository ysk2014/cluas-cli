...
exports.injectVue = function(file, options = {}) {
    ...
    let source = fs.readFileSync(path.join(options.cwd, file), "utf-8");
...
exports.injectVueModule = function(file, options = {}) {
    process.env.CLUAS_CLI_DEBUG && logger.log("执行 api.injectVueModule 操作...");
...
exports.injectVueRoutes = function(file, options = {}) {
    process.env.CLUAS_CLI_DEBUG && logger.log("执行 api.injectVueRoutes 操作...");
